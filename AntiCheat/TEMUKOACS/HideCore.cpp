...
DWORD HideCore::HideModuleLinks(HMODULE Base)
{
...
bool HideCore::CreateInfoData(PANTI_MODULE_INFO pami, HMODULE hModule)
{
...
void HideCore::DestroyIAT(HMODULE hModule)
{
...
void HideCore::DestroySections(HMODULE hModule)
{

...
protected:
	size_t					m_iCurSel;		
	std::list<CN3UIString*>	m_ListString;	
...
public:
	...
	int		AddString(const std::string& szString, const std::string& szExtra);
	int		AddString(const std::string& szString, const std::string& szExtra, const std::string& szExtra2);

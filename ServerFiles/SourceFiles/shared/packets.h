...
#define WIZ_HOOK_GUARD	0xA1	// HackShield Guard
...
enum ServerUniteSelectingCharNameErrorOpcode
{
	CannotCharacterID = 0,
...
enum FishingErrors
{
	FishingResultError			= 0, // "Fishing failed"
	FishingResultSuccess		= 1, // nothing is displayed
	FishingResultFishingAlready = 2, // "Fishing already"
	FishingResultNotFishingArea = 3, // "Not Fishing area"
	FishingResultPreparing		= 4, // "Preparing fishing"
	FishingResultNotRod			= 5, // "A rods is not" (i.e. invalid equipped item, need a rod)
	FishingResultNothingFound	= 6, // "Nothing found"
	FishingResultNoRainworm		= 7, // "No rainworm does exist in inventory"
};

#define MINING_DELAY			5 // seconds
#define FISHING_DELAY			3 // seconds

...
public:
	...
	Socket(SOCKET fd, uint32 sendbuffersize, uint32 recvbuffersize, bool s_bKeepAlive = false);

	// Open a connection to another machine.
	bool Connect(const char * Address, uint32 Port, bool isBlocking = true);
	...
	INLINE bool isOfflineSystemSocket() { return m_bOfflineSystemSocketType; }
	INLINE bool isOfflineSystemTimeSocket() { return m_bOfflineSystemTimeType; }
	INLINE uint32 isOfflineSystemTime() { return m_bOfflineSystemTime; };
...
protected:
	...
	bool m_bOfflineSystemSocketType;
	bool m_bOfflineSystemTimeType;
	uint32 m_bOfflineSystemTime;

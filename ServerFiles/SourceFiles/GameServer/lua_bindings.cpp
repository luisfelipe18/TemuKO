...
#define LUA_CLASS CUser
	...
	(
		...
		MAKE_LUA_METHOD(CastleSiegeWarDeathmacthRegister)
		MAKE_LUA_METHOD(CastleSiegeWarDeathmacthCancelRegister)
...
LUA_WRAPPER_USER_FUNCTION(GiveNPoints);
...
_LUA_WRAPPER_USER_FUNCTION(CheckCastleSiegeWarDeathmachRegister, CastleSiegeWarDeathmacthRegister);
_LUA_WRAPPER_USER_FUNCTION(CheckCastleSiegeWarDeathmacthCancelRegister, CastleSiegeWarDeathmacthCancelRegister);
